...
<div class="row form-container">
    <div class="col-md-6">
        ...
        <form action="">
          ...
          <div class="row g-2 align-items-center">
            <div class="col-auto col-md-6">
                @if ($surat->status->nama_status === 'Belum Diajukan')
                    
                <form action="/arsip/{{ $surat->id }}/acc" class="d-inline">
                    @csrf
                    <button type="submit" name="action" class="btn btn-success" value="1">Ajukan</button>
                </form>
                <button type="button" class="btn btn-danger d-inline" data-bs-toggle="modal" data-bs-target="#deletemodal">Hapus</button>
                <form action="/arsip/{{ $surat->id }}/edit" class="d-inline">
                    @csrf
